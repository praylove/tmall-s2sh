...
<div class="g-mid">
	...
	<table border="1" class="m-list">
		...
		<tbody>
			<s:iterator value="%{page.params}" var="c" >
				<tr>
					<td>${c.id}</td>
					...
					<td>
						<a href="category_edit?id=${c.id}"><span class="glyphicon glyphicon-edit"></span></a>
					</td>
					<td>
						<a class="delete" href="category_delete?category.id=${c.id}"><span class="glyphicon glyphicon-trash"></span></a>
					</td>
				</tr>
			</s:iterator>
		</tbody>
...
<div class="panel panel-warning m-category-add">
	...
	<div class="panel-body">
		<form id="submit" method="post" action="category_add" enctype="multipart/form-data">
